...
const Reports = () => {
  ...
  return (
    <Card className="w-full shadow-lg h-[79vh]">
      <CardHeader className="font-semibold text-slate-600 p-2 px-6">
                ...
                >
                  <div className="flex justify-center items-center gap-2">
                    ...
                    <div className="flex justify-start items-start flex-col">
                      <span className="text-slate-600 font-semibold flex justify-start items-start gap-4">
                        {item.title}
                      </span>

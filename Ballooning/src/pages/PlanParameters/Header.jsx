  ...
  return (
    <React.Fragment>
      <div className="text-lg font-bold text-slate-700 capitalize flex justify-start items-center gap-2">
        <NewspaperIcon />
        Manufacturing Plan - ConnectingRod [ 1 ]
      </div>
      <div className="flex justify-center items-center gap-2">
        <TooltipProvider>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                size="sm"
                className="bg-orange-100 text-orange-500  rounded-sm hover:bg-orange-300 px-4 py-0"
              >
                <PlusIcon className="size-4 cursor-pointer mr-1" />
                Export
              </Button>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button className="bg-slate-100 text-slate-500  rounded-sm hover:bg-slate-300 px-4 py-0">
